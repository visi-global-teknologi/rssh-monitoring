...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="device-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Unique Code</th>
    ...
    <input type="hidden" name="route_api_private_datatable_device" value="{{ route('api.private.datatable.device') }}"/>
@endsection
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/datatable/device.js') }}"></script>
@endsection
