...
@section('title') Rssh Log @endsection
...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="rssh-log-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Log</th>
                                <th>Is Error ?</th>
    ...
    <input type="hidden" name="route_api_private_datatable_rssh_log" value="{{ route('api.private.datatable.rssh-log') }}"/>
@endsection
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/datatable/rssh-log.js') }}"></script>
@endsection
