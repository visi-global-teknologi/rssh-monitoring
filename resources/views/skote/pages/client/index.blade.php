...
@section('content')
    ...
    <div class="d-flex justify-content-end align-items-center py-2">
        <a href="{{ route('clients.create') }}" class="btn btn-primary w-m">Create Client</a>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="client-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Active Status</th>
    ...
    <input type="hidden" name="route_api_private_datatable_client" value="{{ route('api.private.datatable.client') }}"/>
@endsection
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/datatable/client.js') }}"></script>
@endsection
